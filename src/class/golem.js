...
class Golem {
    constructor(level, animation) {
        ...
        this.str_base = monster_attribute.g.str_base;
        this.str_grow = monster_attribute.g.str_grow;
        this.vit_base = monster_attribute.g.vit_base;
        this.vit_grow = monster_attribute.g.vit_grow;
        this.moveSpeed = monster_attribute.g.moveSpeed;
