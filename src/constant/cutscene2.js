				...
				"Stolen Items", "Woodmon Villager", () => {
					...
					"Stolen Items", "Raiz", () => {
						...
						"Stolen Items", "Woodmon Villager", () => {
							...
							"we live in. We know how to handle them. They just need a tad bit of discipline\n" +
							"I can lend you a hand in getting your heirlooms back.\"",
							"Stolen Items", "Raiz", () => {
								util.conversationBox(this, "dialog_frame", "hud", "dialog_button", 
								"\"You... you can? Well, if you really can then, all right, young lord. Please\n" +
								"help us. Those heirlooms are of great worth to us. If you manage to get them\n" +
								"back, I will speak positive words of you and your people.\"",
								"Stolen Items", "Woodmon Villager", () => {
									util.conversationBox(this, "dialog_frame", "hud", "dialog_button", 
